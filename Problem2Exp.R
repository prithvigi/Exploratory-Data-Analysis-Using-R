...
ggplot(head(age1,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age2,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age3,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age4,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age5,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age6,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
ggplot(head(age7,31),aes(x=reorder(day,-Clicks),y=Clicks,fill=day)) + geom_bar(stat="identity")
...
ggplot(head(age2,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age1,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age3,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age4,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age5,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age6,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")
ggplot(head(age7,31),aes(x=day,y=(Clicks/Impressions),fill=day)) + geom_bar(stat="identity")


day20<- mainframe[mainframe$day=="20th",]
day27<- mainframe[mainframe$day=="27th",]

ggplot(day20,aes(x=agecat,y=Clicks,fill=agecat)) + geom_bar(stat="identity")
ggplot(day20,aes(x=agecat,y=Impressions,fill=agecat)) + geom_bar(stat="identity")
ggplot(day27,aes(x=agecat,y=Clicks,fill=agecat)) + geom_bar(stat="identity")
ggplot(day27,aes(x=agecat,y=Impressions,fill=agecat)) + geom_bar(stat="identity")
